...
@app.callback(
    [Output('line-chart', 'figure'), #ids must match the ids in the layout, and must be in the same order
...
def update_graphs(selected_dataset, a, b, c, d):
    ...
    return line_fig, pie_fig # in the same order as the Output in the wrapper
